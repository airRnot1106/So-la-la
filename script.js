...
const music02 = {
    ...
    musicData: [    
                //Intro
                    [2, 0, 1], [4, 0, 0], [4, 0, 0], 
                    [2, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [2, 0, 1], [4, 0, 0], [4, 0, 0], 
                    [2, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 1], [4, 0, 1], [4, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [2, 0, 0], [4, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [2, 0, 1], 
                    [8, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], //
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [4, 0, 1], [4, 0, 0], 
                    [2, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [2, 0, 1], [4, 0, 0], [4, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                //A_melo
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [2, 0, 1], 
                    [2, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [1, 1, 0],
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 1, 0], [2, 1, 0], 
                    [1, 1, 0],
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 1], [4, 0, 1], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 0], [8, 0, 1], [8, 0, 0], [4, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [4, 0, 1],
                //B_melo
                    [2, 1, 0], [4, 1, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 0], [8, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 1], 
                    [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0],
                    [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], 
                    [2, 1, 0], [4, 1, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 0], [8, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 1], 
                    [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0],
                    [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], 
                    [2, 0, 0], [2, 0, 0], 
                    [4, 0, 0], [8, 0, 1], [16, 0, 0], [16, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0],
                    [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 0], [2, 0, 0], 
                    [4, 0, 0], [8, 0, 1], [16, 0, 0], [16, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], 
                    [4, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0],
                //Sabi
                    [2, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    ...
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], //
                    [2, 0, 1], 
                    [8, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], //
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], [16, 0, 0], [16, 0, 1], [16, 0, 1], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [4, 0, 1], [4, 0, 0], 
                ...
                //Interlude
                    ...
                    [4, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 0], [2, 0, 0],
                    [2, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [2, 0, 0], [2, 0, 0],
                    [4, 0, 0], [4, 0, 1], [4, 0, 0], [4, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], 
                //
                    [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], 
                    [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], 
                    [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], 
                    [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 1], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0],
                //
                    [8, 0, 0], [8, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 1], [8, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [8, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 1], [8, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [8, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 1], [8, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [8, 0, 1], [8, 0, 0], [4, 0, 1], [4, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [4, 0, 0], [8, 0, 1], [8, 0, 0], [4, 0, 1], [8, 0, 0], [8, 0, 1], 
                //  
                    [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], 
                    [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0],
                    [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], [8, 0, 0], [16, 0, 0], [16, 0, 0], 
                    [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], 
                    [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], 
                    [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 1], [16, 0, 0], [16, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0],
                //
                    [4, 0, 1], [4, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [8, 0, 1], [16, 0, 1], [16, 0, 0], [4, 0, 0], [4, 0, 0], 
                    [4, 0, 0], [8, 0, 1], [8, 0, 0], [2, 0, 1],
                    [83, 0, 1], [83, 0, 1], [83, 0, 0], [83, 0, 1], [83, 0, 0], [83, 0, 1], [83, 0, 0], [83, 0, 1], [83, 0, 0], [83, 0, 1], [83, 0, 0], [83, 0, 1], 
                    [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
                    [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [16, 0, 0], [16, 0, 0],
                    [8, 0, 1], [16, 0, 0], [16, 0, 0],[8, 0, 1], [16, 0, 0], [16, 0, 0],[8, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 0], 
                    [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 1], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], [16, 0, 0], 
                //Sabi
                    [2, 0, 0], [4, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 1], [8, 0, 1], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 0], 
                    [4, 0, 0], [8, 0, 0], [8, 0, 0], [8, 0, 1], [8, 0, 0], [8, 0, 1], [8, 0, 0], 
